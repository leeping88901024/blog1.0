                ...
                <div>
                    <div className="frame">
                        <header className="codrops-header">
                            <h1 className="codrops-header__title"><Link prefetch href='\'><a>主页</a></Link></h1>
                        </header>
                        <p className="info">{dayjs(new Date()).format("dddd MMMM YYYY ")} &middot; 昆明 &middot; 云南 &middot; CN</p>
                        ...
                        <div className="menu__item menu__item--1" data-direction="bt">
                            <div className="menu__item-inner">
                                <div className="mainmenu">
                                    <Link prefetch href='\blog'><a className="mainmenu__item">文章</a></Link>
                                    <a href="#" className="mainmenu__item">故事2</a>
                                    <a href="#" className="mainmenu__item">故事2</a>
                                    <a href="#" className="mainmenu__item">故事2</a>
                                </div>
                                <p className="label label--topleft label--vert-mirror">似乎这是重要的东西</p>
                                <p className="label label--bottomright label--vert">我在昆明</p>
                            </div>
                        </div>
                        ...
                        <div className="menu__item menu__item--3" data-direction="bt">
                            <div className="menu__item-inner">
                                <div className="sidemenu">
                                    <a href="#" className="sidemenu__item"><span className="sidemenu__item-inner">游戏</span></a>
                                    <a href="#" className="sidemenu__item"><span className="sidemenu__item-inner">About LARP</span></a>
                                    <a href="#" className="sidemenu__item"><span className="sidemenu__item-inner">游戏规则</span></a>
                                    ...
                                    <a href="#" className="sidemenu__item"><span className="sidemenu__item-inner">还有什么</span></a>
